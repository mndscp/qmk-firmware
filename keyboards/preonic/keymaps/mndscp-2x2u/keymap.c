...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_QWERTY] = LAYOUT_preonic_2x2u(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LNG1,          NAV_SPC,      SYM_SPC,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
  ...
  [L_GAME] = LAYOUT_preonic_2x2u(
    ...
    _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_QUOT,
  ...
  [L_CTRL] = LAYOUT_preonic_2x2u(
    ...
    XXXXXXX, C_A,     C_S,     C_D,     C_F,     C_G,          C_H,     M_AE,    M_OE,    M_UE,    M_SZ,    KC_ENT,
    _______, C_Z,     C_X,     C_C,     C_V,     C_B,          C_N,     C_M,     C_COMM,  C_DOT,   _______, KC_QUOT,
  ...
  [L_SYMBOL] = LAYOUT_preonic_2x2u(
    ...
    _______, _______, _______, _______,          NAV_SPC,      XXXXXXX,          _______, _______, _______, _______
  ),
