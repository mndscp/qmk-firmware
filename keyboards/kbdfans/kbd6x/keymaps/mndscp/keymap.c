...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_A] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, C_Z,     KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______,
    _______, _______, KC_LALT, KC_LCTL, KC_LSFT, _______, KC_TAB,  KC_LEFT, KC_DOWN, KC_RGHT, KC_COLN,  KC_DQUO, KC_ESC,
